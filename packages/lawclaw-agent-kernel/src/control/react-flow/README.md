...
业务协议的历史定义见[归档](../../../docs/governance/archive/flow-before-system-v1/flow-engine.md)，当前框架见[FlowEngine设计](../../../docs/design/layers/l1-control/components/flow-engine/README.md)。业务单元/契约测试为AK-FE-001～018，耐久集成为AK-FE-019～029；系统框架用例独立编号AK-FS。
