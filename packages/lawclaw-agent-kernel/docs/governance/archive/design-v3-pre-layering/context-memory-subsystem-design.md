> **非规范性归档：** 已由 L1 的 [ContextEngine](../../../design/layers/l1-control/components/context-engine.md)、[MemoryManager](../../../design/layers/l1-control/components/memory-manager.md)和[SessionManager](../../../design/layers/l1-control/components/session-manager.md)取代。
