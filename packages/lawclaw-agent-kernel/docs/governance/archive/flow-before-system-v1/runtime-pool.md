...
能力保留原层级与Port所有权，首版随[run-scheduler内部协作设计](run-scheduler.md)交付，不独立建设服务或状态库。详细流程与测试见目标文档`L1-CMP-012 / CD-1`节；数据见[CD-1](../../../contracts/component-development-contracts-v1.md#runtime-pool)。只合并开发任务，不移动架构层、不删除安全检查。
