...
- 位置：`packages/lawclaw-agent-kernel/docs/design/layers/l1-control/components/flow-engine.md:2252-2254`、`:2332-2334`（关联 `:2320`、`:2350-2355`）。
...
- 位置：`packages/lawclaw-agent-kernel/docs/design/layers/l1-control/components/flow-engine.md:2256`、`:2293-2297`、`:2343`、`:2353`、`:2460`。
