...
- 位置：`packages/lawclaw-agent-kernel/docs/design/layers/l1-control/components/flow-engine/README.md:1782`；关联 `1740`、`2449`、`2491`。
...
- 位置：`packages/lawclaw-agent-kernel/docs/design/layers/l1-control/components/flow-engine/README.md:2380`；数据位置 `flow-engine-contract-v1.examples.json:4-30`。
...
- 位置：`packages/lawclaw-agent-kernel/docs/design/layers/l1-control/components/flow-engine/README.md:1852-1864`；关联 `1753`、`2447`。
